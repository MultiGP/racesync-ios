...
public class BadgeHub: NSObject {
    ...
    fileprivate var curOrderMagnitude: Int = 0
    ...
    fileprivate var redCircle: BadgeView!
    fileprivate var initialCenter = CGPoint.zero
    fileprivate var baseFrame = CGRect.zero
